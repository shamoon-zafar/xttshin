...
config = VitsConfig(
    ...
    test_sentences=[
        ...
        #["සුප්පියස්ස පන පරිබ්බාජකස්ස අන්තෙවාසී බ්‍රහ්මදත්තො මාණවො අනෙකපරියායෙන බුද්ධස්ස වණ්ණං භාසති, ධම්මස්ස වණ්ණං භාසති, සඞ්ඝස්ස වණ්ණං භාසති."],
        #["නමො තස්ස භගවතො අරහතො සම්මා සම්බුද්ධස්ස"],
        #["මනොපුබ්බඞ්ගමා ධම්මා මනොසෙට්ඨා මනොමයා x මනසා චෙ පදුට්ඨෙන භාසති වා කරොති වා x තතො නං දුක්ඛමන්වෙති, චක්කං'ව වහතො පදං."],
        #["මාලාගන්‍ධවිලෙපනධාරණමණ්ඩනවිභූසනට්ඨානා වෙරමණීසික්ඛාපදං සමාදියාමි."],
        #["සෙඛබලසඞ්ඛිත්තසුත්තං"],
    ],
    print_step=25,
    print_eval=True,
